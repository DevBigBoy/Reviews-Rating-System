 ...
 if (isset($_POST['submit'])) {
    ...
    if ($verfiy_email->rowCount() > 0) {
        ...
        if($c_pass == 1){
            ...
            $insert_user->execute([$id,$f_name,$l_name,$email,$pass,$image,$sex]);
...
<body>
    ...
    <section class="account-form">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="f_name" require maxlength="30" placeholder="enter your first name" class="box">

            <p class="placeholder">your Last Name <span>*</span></p>
            <input type="text" name="l_name" require maxlength="30" placeholder="enter your last name" class="box">
            ...
            <input type="password" name="pass" require maxlength="100" placeholder="enter your password" class="box">

            <p class="placeholder">confirm password <span>*</span></p>
            <input type="password" name="c_pass" require maxlength="100" placeholder="confirm your password"
                class="box">
